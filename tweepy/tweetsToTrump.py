...
searchQuery = '@realdonaldtrump'  # term to be searched. here tweets written to donald trump
maxTweets = 10000 # Some arbitrary large number
tweetsPerQry = 100  # this is the max the API permits
fName = 'csv/@realdonaldtrump.csv' # We'll store the tweets in a text file.
