...
def tweets_to_user():
    ...
    searchQuery = input("Enter @USER : ")  # term to be searched. here tweets written to donald trump
    maxTweets = int(input("Number of tweets (min - 100): ")) # Some arbitrary large number
            ...
            try:
                ...
                for tweet in new_tweets:
                    outTweets = [tweet.user.name.encode('utf-8'), tweet.user.screen_name.encode('utf-8'),
                         ...
                         tweet.lang, tweet.source.encode('utf-8'), tweet.retweeted, tweet.in_reply_to_screen_name,
